...
public class ProjectServiceImpl implements ProjectService {
	 ...
	 * @param user
	 *            : the user
	 * @return true if operation works ok false if the user could not be found for the project
	 */
	...
	/**
	 * 4. List project composition for a project or for all the projects GW Ana qa jr Maria dev sr
	 * 
	 * @param project
	 *            : the project
	...
	/**
	 * 6. List jr/mid/dev for a project and for a role GW Dev Sr – 40% Mid – 10% Jr – 50% QA Sr – 80% Mid – 20% Jr – 0%
	 * 
	 * @param project
	 *            : the project
	...
	public Project create(Project project) {
		System.out.println("creating project in service");
